...
export const Navbar = () => {
  ...
  return (
    <header className="h-16 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-700 flex items-center justify-between px-6 z-10 sticky top-0 shrink-0 transition-colors duration-300">
      {/* Left section: toggle and Search Bar */}
      <div className="flex items-center gap-4 flex-1 max-w-md">
        <button className="md:hidden text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
